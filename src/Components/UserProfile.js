...
async function  getUserProfile(){
	try {
		...
		if( resJson.statusCode === 200 ) {
			...
			userProfileData.dateEmbauche = moment( userProfileData.dateEmbauche, 'YYYY-MM-DDTHH:mm:ss' ).format("X").parseInt();
			userProfileData.dateDepart = moment( userProfileData.dateDepart, 'YYYY-MM-DDTHH:mm:ss' ).format("X").parseInt(); 
